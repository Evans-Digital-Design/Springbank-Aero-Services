...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-md 6 mt-4 ">
        ...
        <h1 class=" form__title text-blue text-center mb-10">Delete Product</h1>

        
        <div class="form__input-group">
        <button class="mt-4 btn btn-primary btn-lg d-flex justify-items-center " name="submit" type="submit">Delete</button>
        </div>
